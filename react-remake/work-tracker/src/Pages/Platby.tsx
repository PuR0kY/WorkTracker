        ...
        <div id="canvas">
            <ul className="list">
                <li className="counter-container">
                    <button onClick={() => setCount(count + 1)}>Smazaná platba</button>
                ...
                <li className="counter-container">
                    <button onClick={() => setCount3(count3 + 1)}>Spoluřešitelka</button>
                    <div id="counter3" className="counter">{count3}</div>
                </li>

                <li className="counter-container">
                    <button onClick={() => setCount4(count4 + 1)}>Identifikace plateb</button>
                    <div id="counter4" className="counter">{count4}</div>
                </li>

                <li className="counter-container">
                    <button onClick={() => setCount5(count5 + 1)}>ACKY</button>
                    <div id="counter5" className="counter">{count5}</div>
                </li>

                <li className="counter-container">
                    <button onClick={() => setCount6(count6 + 1)}>MOI</button>
                    <div id="counter6" className="counter">{count6}</div>
                </li>

                <li className="counter-container">
                    <button onClick={() => setCount7(count7 + 1)}>SDE požadavek</button>
                    <div id="counter7" className="counter">{count7}</div>
                </li>

                <li className="counter-container">
                    <button onClick={() => setCount8(count8 + 1)}>MT191 v TS</button>
